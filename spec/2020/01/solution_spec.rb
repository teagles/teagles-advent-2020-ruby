...
RSpec.describe Year2020::Day01 do
  ...
  describe 'part 1' do
    it 'returns 514579 for the example input' do
      expect(described_class.part_1(example_input)).to eq(514_579)
    end

    it 'returns 960075 for my input' do
      expect(described_class.part_1(input)).to eq(960_075)
    end
  end

  describe 'part 2' do
    it 'returns 241861950 for the example input' do
      expect(described_class.part_2(example_input)).to eq(241_861_950)
    end

    it 'returns 212900130 for my input' do
      expect(described_class.part_2(input)).to eq(212_900_130)
    end
  end
end
